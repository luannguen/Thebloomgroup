  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-slate-300 bg-transparent text-slate-800 hover:bg-slate-100 hover:text-slate-950",
        "outline-light":
          "border-2 border-white/60 bg-transparent text-white hover:bg-white hover:text-slate-950 backdrop-blur-sm",
        secondary:
          "bg-slate-100 text-slate-800 hover:bg-slate-200 border border-slate-200/80 shadow-sm",
        accent:
          "bg-amber-500 text-slate-950 hover:bg-amber-600 font-bold shadow-md",
