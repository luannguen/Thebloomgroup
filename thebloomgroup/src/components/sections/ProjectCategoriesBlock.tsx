...
export const ProjectCategoriesBlock = ({
  ...
  const displaySubtitle = subtitle || t('project_cat_desc_list', 'Thebloomgroup tự hào thực hiện các dự án đa dạng với quy mô khác nhau, từ hệ thống điều hòa không khí trung tâm đến các hệ thống làm lạnh công nghiệp phức tạp.');
