...
export const ProjectOverviewBlock = ({
  ...
  const defaultDesc = t('projects_overview_desc', 'Với hơn 20 năm kinh nghiệm, Thebloomgroup đã thực hiện hàng trăm dự án lớn nhỏ trong lĩnh vực điện lạnh công nghiệp và dân dụng. Chúng tôi tự hào là đối tác tin cậy của nhiều tập đoàn lớn và các đơn vị hàng đầu trong các ngành công nghiệp.');
