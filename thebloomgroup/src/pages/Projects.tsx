          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                {t('projects_overview_desc', 'Với hơn 20 năm kinh nghiệm, Thebloomgroup đã thực hiện hàng trăm dự án lớn nhỏ trong lĩnh vực điện lạnh công nghiệp và dân dụng. Chúng tôi tự hào là đối tác tin cậy của nhiều tập đoàn lớn và các đơn vị hàng đầu trong các ngành công nghiệp.')}
              </p>
        ...
        <div className="container-custom">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              {t('project_cat_desc_list', 'Thebloomgroup tự hào thực hiện các dự án đa dạng với quy mô khác nhau, từ hệ thống điều hòa không khí trung tâm cho tòa nhà thương mại đến các hệ thống làm lạnh công nghiệp phức tạp.')}
            </p>
          </div>
        ...
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground mb-8">
              ...
              Thebloomgroup cam kết mang đến các giải pháp điện lạnh hiện đại, hiệu quả và tiết kiệm chi phí.
            </p>
