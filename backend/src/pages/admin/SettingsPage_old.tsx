            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="px-4 py-5 sm:p-6 space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex-1 space-y-1">
                                ...
                                <p className="text-sm text-gray-500">
                                    Sß╗¡ dß╗Ñng cho phß║ºn d╞░ß╗¢i trang. Nß║┐u ─æß╗â trß╗æng sß║╜ sß╗¡ dß╗Ñng Logo Header.
                                </p>
                                <div className="mt-2">
                        ...
                        <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex-1 space-y-1">
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    Favicon (Biß╗âu t╞░ß╗úng thanh tr├¼nh duyß╗çt)
                                </label>
                                <p className="text-sm text-gray-500">
                                    Khuy├¬n d├╣ng ß║únh vu├┤ng, ─æß╗ïnh dß║íng .ico, .png, hoß║╖c .svg (v├¡ dß╗Ñ 32x32px).
                                </p>
                                <div className="mt-2">
                                    <label htmlFor="favicon-upload" className="cursor-pointer inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                        ...
                                        {uploadingFavicon ? t('uploading') : '─Éß╗òi Favicon'}
                                    </label>
                                    <input
                                        id="favicon-upload"
                                        type="file"
                        ...
                        <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex-1 space-y-1">
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    ß║ónh Mß║íng X├ú Hß╗Öi (OG Image)
                                </label>
                                <p className="text-sm text-gray-500">
                                    ß║ónh hiß╗ân thß╗ï khi chia sß║╗ link l├¬n Facebook, Zalo, Twitter. Khuy├¬n d├╣ng tß╗ë lß╗ç 1200x630px.
                                </p>
                                <div className="mt-2">
                                    <label htmlFor="og-image-upload" className="cursor-pointer inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                        ...
                                        {uploadingOgImage ? t('uploading') : '─Éß╗òi ß║ónh'}
                                    </label>
                                    <input
                                        id="og-image-upload"
                                        type="file"
                        ...
                        <div className="grid grid-cols-1 gap-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Tß╗òng c├┤ng ty Kß╗╣ thuß║¡t lß║ính Viß╗çt Nam (VVC)"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    className="mt-1 shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md p-2 border dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                    placeholder="Ti├¬n phong trong l─⌐nh vß╗▒c kß╗╣ thuß║¡t lß║ính tß║íi Viß╗çt Nam"
                                />
                            </div>
                            <div>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">T├¬n miß╗ün Website (Domain URL)</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Tß╗½ Kh├│a SEO (Meta Keywords)</label>
                                <input
                                    type="text"
                                    value={settings['site_keywords'] || ''}
                                    onChange={(e) => handleChange('site_keywords', e.target.value)}
                                    className="mt-1 shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md p-2 border dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                    placeholder="v├¡ dß╗Ñ: ─æiß╗çn lß║ính, m├íy lß║ính, thi c├┤ng..."
                                />
                            </div>
                            <div>
                ...
                <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg">
                    <div className="px-4 py-5 sm:p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-y-6">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-4">{t('address')} & Hß╗ç thß╗æng Chi nh├ính</label>
                                    ...
                                    {(() => {
                                        ...
                                        return (
                                            <div className="space-y-6">
                                                    ...
                                                    <div key={branch.id} className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-700 relative group">
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            <div className="md:col-span-1">
                                                                <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 block">T├¬n Chi nh├ính / V─ân ph├▓ng</label>
                                                                <input
                                                                    type="text"
                                                                    value={branch.title}
                                                                    ...
                                                                    placeholder="e.g. Trß╗Ñ sß╗ƒ ch├¡nh, Workshop..."
                                                                />
                                                            </div>
                                                            <div className="md:col-span-1">
                                                                <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 block">Ti├¬u ─æß╗ü phß╗Ñ (Vß╗ï tr├¡)</label>
                                                                <input
                                                                    type="text"
                                                            ...
                                                            <div className="md:col-span-2">
                                                                <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 block">─Éß╗ïa chß╗ë chi tiß║┐t</label>
                                                                <div className="relative">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        placeholder="Sß╗æ nh├á, t├¬n ─æ╞░ß╗¥ng, quß║¡n/huyß╗çn..."
                                                                    />
                                                                </div>
                                                            </div>
                                                            <div>
                                                                <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 block">Sß╗æ ─æiß╗çn thoß║íi</label>
                                                                <div className="relative">
                                                            ...
                                                            <div>
                                                                <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 block">Email li├¬n hß╗ç</label>
                                                                <div className="relative">
                                                            ...
                                                            <div className="md:col-span-2">
                                                                <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1 block">Google Maps Link (T├╣y chß╗ìn)</label>
                                                                <div className="relative">
                                                ...
                                                >
                                                    <Plus size={18} />
                                                    Th├¬m chi nh├ính / V─ân ph├▓ng mß╗¢i
                                                </button>
                                            </div>
                                        );
                                    })()}
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="mt-1 shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md p-2 border dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        placeholder="8:00 - 17:30, Thß╗⌐ 2 - Thß╗⌐ 6"
                                    />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="px-4 py-5 sm:p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="D├ín m├ú nh├║ng <iframe> hoß║╖c link nh├║ng Google Maps..."
                            />
                            <p className="mt-1 text-xs text-gray-500">Bß║ín c├│ thß╗â d├ín to├án bß╗Ö m├ú &lt;iframe&gt; tß╗½ Google Maps, hß╗ç thß╗æng sß║╜ tß╗▒ ─æß╗Öng lß╗ìc lß║Ñy link nh├║ng chuß║⌐n.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg lg:col-span-2">
                    <div className="px-4 py-5 sm:p-6 space-y-6">
                        <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">N├óng cao (Advanced)</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Header Scripts (Th├¬m v├áo &lt;head&gt; - GTM, Fb Pixel...)</label>
                                <textarea
                                    rows={6}
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Footer Scripts (Th├¬m tr╞░ß╗¢c &lt;/body&gt; - Chat widget...)</label>
                                <textarea
                                    rows={6}
